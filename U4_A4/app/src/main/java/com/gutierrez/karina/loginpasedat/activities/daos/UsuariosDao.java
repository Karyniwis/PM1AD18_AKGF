...
public class UsuariosDao {
    ...
    public Usuario usuarioExist(final Usuario validar) {
        ...
        {
            if(usr.getUsuario().equals(validar.getUsuario().toString())&&usr.getPassword().equals(validar.getPassword().toString())&&usr.getNombre().equals(validar.getNombre().toString())&&usr.getApepa().equals(validar.getApepa().toString())&&usr.getApema().equals(validar.getApema().toString()))
                return validar;
        }
        return null;
    }
