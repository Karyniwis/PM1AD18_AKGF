...
public class Login extends Activity {
    EditText usuario,password,nombre,apema,apepa;
    Button btnLogin;
    TextView titulo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apema=(EditText)findViewById(R.id.editText3);
        apepa=(EditText)findViewById(R.id.editText2);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Usuario resultado = dao.usuarioExist(new Usuario(usuario.getText().toString(),password.getText().toString(),nombre.getText().toString(),apepa.getText().toString(),apema.getText().toString()));
